...
const Hero = () => {
    return <section className="w-full flex flex-col items-center bg-dark_bg text-white  px-5 pt-8 pb-16 font-exo">
        <h1 className="text-4xl font-bold text-center text-[#ECF7FD] ">THE 1ST NFT HOTEL & HOSTEL CHAIN </h1>
        <p className="text-3xl text-center py-10 font-bold md:w-9/12 text-[#ECF7FD] ">Palmverse builds technologies that help people connect IRL, join communities, and bridge the web2 travel experience to web3.</p>
